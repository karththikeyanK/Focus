...
import com.gingerx.focusservice.dtoMapper.MailDtoMapper;
...
public class MailClient {
    ...
    public void sendMail(KafkaMessage kafkaMessage) {
        log.info("MailClient::sendMail():: is called");
        RestTemplate restTemplate = new RestTemplate();
        MailDto mailDto = MailDtoMapper.mapToMailDto(kafkaMessage.getPayload());
        try {
